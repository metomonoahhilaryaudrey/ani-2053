...
J'ai créé le projet MonEssai dans le répertoire Applications/MonEssai.
...
# 4. Déclaration au workspace

J'ai ajouté le projet dans Nkentseu.jenga avec :

with include("Applications/MonEssai/MonEssai.jenga"):
    pass

Le bloc a été placé au même niveau d'indentation que les autres instructions include du workspace.

# 5. Vérification avec jenga info

J'ai exécuté :

jenga info

Le projet MonEssai apparaît dans la liste des projets du workspace avec le type ConsoleApp.

Exemple :

MonEssai    ConsoleApp    C++    No    Yes
# Resultat:
Cette vérification confirme que le workspace a bien chargé MonEssai.jenga.
