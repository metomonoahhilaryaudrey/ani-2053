...
J'ai créé un quatrième fichier :
...
Puis j'ai créé un commit sur cette branche :

git commit -m "ajout du fichier4"

Je suis ensuite revenu sur la branche principale :

git switch main

Sur main, j'ai créé un cinquième fichier :
...
Puis j'ai créé un nouveau commit :

git commit -m "ajout du fichier5"

À ce stade, les branches main et nouvelle-branche ont évolué séparément.

J'ai ensuite fusionné la branche nouvelle-branche dans main avec la commande :
